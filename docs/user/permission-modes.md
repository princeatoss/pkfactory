...
Antigravity uses its own permission policy for each mode. PK Factory still shows any approval or
...
PK Factory's separate Plan mode control is not available for Antigravity. See
