...
PK Factory selects a project icon automatically. It checks `pkfactory.json`, common favicon and app icon
...
PK Factory supports SVG, PNG, ICO, JPEG, GIF, AVIF, and WebP files. The selected path applies to
...
PK Factory checks in the background and when the server starts. It uses the branch's configured
