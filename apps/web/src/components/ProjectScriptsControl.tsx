...
const NO_FILE_SCRIPTS: ReadonlyArray<PKFactoryProjectFileScript> = [];

interface ProjectScriptsControlProps {
  scripts: ReadonlyArray<ProjectScript>;
  /** Scripts declared in the project's checked-in pkfactory.json, offered for import. */
  fileScripts?: ReadonlyArray<PKFactoryProjectFileScript>;
...
export default function ProjectScriptsControl({
  ...
  const importFileScript = async (fileScript: PKFactoryProjectFileScript) => {
  ...
  const importMenuItems = importableScripts.length > 0 && (
    <>
      ...
      <MenuGroup>
        <MenuGroupLabel>From pkfactory.json</MenuGroupLabel>
