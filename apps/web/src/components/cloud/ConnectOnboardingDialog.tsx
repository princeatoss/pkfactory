...
import { AuthAdministrativeScopes, AuthRelayWriteScope } from "@pkfactory/contracts";
...
/**
 * Post-sign-in onboarding wizard for PK Factory Connect. Opens on every in-session
 ...
 * account's PK Factory Connect environments so every device can be connected right
...
function ConfiguredConnectOnboardingDialog() {
  ...
  const applyPublishSelection = async () => {
    ...
    toastManager.add({
      type: "success",
      title: "PK Factory Connect enabled",
  ...
  return (
    ...
    >
      <DialogPopup className="max-w-xl">
        <DialogHeader>
          <DialogTitle>Set up PK Factory Connect</DialogTitle>
          <DialogDescription>
    ...
    <div className="space-y-3">
      <div className="rounded-lg border">
        <OnboardingToggleRow
          ...
          description="Make this environment available to your other devices through PK Factory Connect."
