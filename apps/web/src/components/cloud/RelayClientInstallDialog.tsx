...
import type { RelayClientInstallProgressStage } from "@pkfactory/contracts";
    ...
    >
      <DialogPopup className="max-w-md" showCloseButton={isConfirming}>
        <DialogHeader>
          ...
          <DialogDescription>
            {isInstalling
              ? "PK Factory is preparing this environment for secure access through PK Factory Connect."
              : "PK Factory needs the relay client to make this environment available through PK Factory Connect."}
          </DialogDescription>
        </DialogHeader>
          ...
          {isInstalling ? (
            <div className="space-y-2.5">
              ...
              <p className="text-xs leading-relaxed text-muted-foreground">
                Keep PK Factory open while the relay client is installed.
              </p>
            </div>
          ) : (
            <div className="rounded-xl border border-border/70 bg-muted/35 p-3">
              ...
              <p className="mt-1 text-sm leading-relaxed text-muted-foreground">
                PK Factory will download and install version{" "}
