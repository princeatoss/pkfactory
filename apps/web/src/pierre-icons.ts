...
import { VIDEO_FILE_EXTENSIONS } from "@pkfactory/shared/video";
...
const PIERRE_ICON_SPRITE_ID = "pkfactory-pierre-file-icon-sprite";

const PKFACTORY_FILE_ICON_SPRITE = `
<svg xmlns="http://www.w3.org/2000/svg" width="0" height="0" aria-hidden="true">
  <!-- Lucide Film icon, ISC license. -->
  <symbol id="pkfactory-file-icon-video" viewBox="0 0 24 24">
  ...
  <symbol id="pkfactory-file-icon-package-json" viewBox="0 0 32 32">
    <path d="M2 2H30V30H2" fill="#c12127" />
    <path d="M7.25 7.25h17.5v17.5h-3.5v-14H16v14H7.25" fill="#fff" />
  </symbol>
  <symbol id="pkfactory-file-icon-tsconfig" viewBox="0 0 32 32">
  ...
  <symbol id="pkfactory-file-icon-agents" viewBox="0 0 32 32">
  ...
  <symbol id="pkfactory-file-icon-claude" viewBox="0 0 32 32">
  ...
  <symbol id="pkfactory-file-icon-readme" viewBox="0 0 32 32">
  ...
  <symbol id="pkfactory-file-icon-pnpm" viewBox="0 0 32 32">
...
export const PKFACTORY_PIERRE_ICONS = {
  set: "complete",
  colored: true,
  spriteSheet: PKFACTORY_FILE_ICON_SPRITE,
  byFileName: {
    "package.json": "pkfactory-file-icon-package-json",
    "tsconfig.json": "pkfactory-file-icon-tsconfig",
    "agents.md": "pkfactory-file-icon-agents",
    "claude.md": "pkfactory-file-icon-claude",
    "readme.md": "pkfactory-file-icon-readme",
    "pnpm-lock.yaml": "pkfactory-file-icon-pnpm",
    "pnpm-workspace.yaml": "pkfactory-file-icon-pnpm",
  },
  byFileExtension: Object.fromEntries(
    VIDEO_FILE_EXTENSIONS.map((extension) => [extension, "pkfactory-file-icon-video"]),
  ),
} satisfies FileTreeIcons;

const completeIconResolver = createFileTreeIconResolver(PKFACTORY_PIERRE_ICONS);
...
export function ensurePierreIconSprite(): void {
  ...
  container.innerHTML = `${getBuiltInSpriteSheet("complete")}${PKFACTORY_FILE_ICON_SPRITE}`;
