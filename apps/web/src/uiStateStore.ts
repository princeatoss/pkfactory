...
export const PERSISTED_STATE_KEY = "pkfactory:ui-state:v1";
const THREAD_CHANGED_FILES_EXPANSION_VERSION = 1;
const LEGACY_PERSISTED_STATE_KEYS = [
  "pkfactory:renderer-state:v8",
  "pkfactory:renderer-state:v7",
  "pkfactory:renderer-state:v6",
  "pkfactory:renderer-state:v5",
  "pkfactory:renderer-state:v4",
  "pkfactory:renderer-state:v3",
