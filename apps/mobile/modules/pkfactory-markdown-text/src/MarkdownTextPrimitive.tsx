...
import PKFactoryMarkdownTextRunNativeComponent from "./PKFactoryMarkdownTextRunNativeComponent";
import PKFactoryMarkdownTextNativeComponent from "./PKFactoryMarkdownTextNativeComponent";
...
function MarkdownTextPrimitiveChild({
  ...
  const nativeChildren = React.Children.toArray(children).map((child) => {
    ...
    return (
      ...
      <PKFactoryMarkdownTextRunNativeComponent
  ...
  if (!isAncestor) {
    ...
    return (
      <TextAncestorContext.Provider value={contextValue}>
        <PKFactoryMarkdownTextNativeComponent
          {...textDefaults}
          {...containerProps}
          style={[flattenedStyle]}
        >
