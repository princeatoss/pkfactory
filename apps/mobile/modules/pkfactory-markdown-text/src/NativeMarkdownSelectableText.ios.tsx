...
import { installMarkdownCopySanitizer } from "./PKFactoryMarkdownTextSelectionModule";
...
export function NativeMarkdownSelectableText(props: {
  ...
  // PKFactoryMarkdownText only rebuilds its attributed string during native layout. A
        ...
        return (
          <MarkdownTextPrimitive
            ...
            nativeID={
              Platform.OS === "ios"
                ? run.fileIcon
                  ? `pkfactory-file:${Image.resolveAssetSource(markdownFileIconSource(run.fileIcon)).uri}`
                  : run.skillName
                    ? "pkfactory-skill:sf:cube"
                    : undefined
                : undefined
            }
