...
private final class ComposerTextView: UITextView {
  private static let pastedImageDirectoryName = "pkfactory-composer-paste"
...
public final class PKFactoryComposerEditorView: ExpoView, UITextViewDelegate, UITextDropDelegate {
