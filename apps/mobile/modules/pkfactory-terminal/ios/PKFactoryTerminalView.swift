...
public final class PKFactoryTerminalView: ExpoView, UITextFieldDelegate {
  ...
  var terminalKey: String = "" {
    didSet {
      accessibilityIdentifier = "pkfactory-terminal-\(terminalKey)"
  ...
  private func setupWriteCallback() {
    ...
    ghostty_surface_set_write_callback(surface, { userdata, data, len in
      ...
      let view = Unmanaged<PKFactoryTerminalView>.fromOpaque(userdata).takeUnretainedValue()
  ...
  private func writeThemeConfigFile() -> String? {
    ...
    let url = URL(fileURLWithPath: NSTemporaryDirectory())
      .appendingPathComponent("pkfactory-terminal-theme-\(appearance.rawValue).ghostty")
