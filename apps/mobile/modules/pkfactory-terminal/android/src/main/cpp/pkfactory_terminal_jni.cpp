...
constexpr uint32_t kSnapshotMagic = 0x54563354;  // "PKFactoryVT" in little endian.
...
Java_expo_modules_pkfactoryterminal_GhosttyBridge_nativeCreate(
...
Java_expo_modules_pkfactoryterminal_GhosttyBridge_nativeDestroy(JNIEnv*, jclass, jlong handle) {
  FreeSession(FromHandle(handle));
}

extern "C" JNIEXPORT jbyteArray JNICALL
Java_expo_modules_pkfactoryterminal_GhosttyBridge_nativeFeed(JNIEnv* env, jclass, jlong handle,
                                                       jbyteArray data) {
...
extern "C" JNIEXPORT jbyteArray JNICALL
Java_expo_modules_pkfactoryterminal_GhosttyBridge_nativeResize(
...
extern "C" JNIEXPORT void JNICALL
Java_expo_modules_pkfactoryterminal_GhosttyBridge_nativeScroll(JNIEnv*, jclass, jlong handle,
                                                         jint rows) {
  auto* session = FromHandle(handle);
...
extern "C" JNIEXPORT void JNICALL
Java_expo_modules_pkfactoryterminal_GhosttyBridge_nativeSetTheme(
...
Java_expo_modules_pkfactoryterminal_GhosttyBridge_nativeSelectWordAt(JNIEnv*, jclass,
                                                               jlong handle, jint x,
                                                               jint y) {
  auto* session = FromHandle(handle);
...
extern "C" JNIEXPORT void JNICALL
Java_expo_modules_pkfactoryterminal_GhosttyBridge_nativeExtendSelection(
...
extern "C" JNIEXPORT jboolean JNICALL
Java_expo_modules_pkfactoryterminal_GhosttyBridge_nativeSelectAll(JNIEnv*, jclass,
                                                            jlong handle) {
  auto* session = FromHandle(handle);
  if (session == nullptr) return JNI_FALSE;
  std::lock_guard<std::mutex> lock(session->mutex);
...
extern "C" JNIEXPORT void JNICALL
Java_expo_modules_pkfactoryterminal_GhosttyBridge_nativeClearSelection(JNIEnv*, jclass,
                                                                 jlong handle) {
  auto* session = FromHandle(handle);
  if (session == nullptr) return;
  std::lock_guard<std::mutex> lock(session->mutex);
...
extern "C" JNIEXPORT jbyteArray JNICALL
Java_expo_modules_pkfactoryterminal_GhosttyBridge_nativeGetSelectionText(JNIEnv* env, jclass,
                                                                   jlong handle) {
  auto* session = FromHandle(handle);
...
extern "C" JNIEXPORT jbyteArray JNICALL
Java_expo_modules_pkfactoryterminal_GhosttyBridge_nativeSnapshot(JNIEnv* env, jclass,
                                                           jlong handle) {
  auto* session = FromHandle(handle);
  if (session == nullptr) return env->NewByteArray(0);
  std::lock_guard<std::mutex> lock(session->mutex);
