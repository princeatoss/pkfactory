    ...
    <View className="flex-row items-center gap-3">
      ...
      <View className="gap-1">
        <View className="flex-row items-center gap-2">
          <Text className="text-lg font-pkfactory-bold tracking-[-0.4px] text-foreground">
            PK Factory
          </Text>
          <View className="rounded-full bg-subtle px-2 py-1">
            <Text className="text-3xs font-pkfactory-bold tracking-[1.1px] uppercase text-foreground-muted">
              {stageLabel}
            </Text>
          </View>
        </View>
