...
import { EnvironmentProject, EnvironmentThreadShell } from "@pkfactory/client-runtime/state/shell";
...
import type { GitRunStackedActionResult } from "@pkfactory/contracts";
import {
