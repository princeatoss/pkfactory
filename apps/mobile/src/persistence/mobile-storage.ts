...
const CONNECTIONS_KEY = "pkfactory.connections";
const AGENT_AWARENESS_DEVICE_ID_KEY = "pkfactory.agent-awareness.device-id";
const AGENT_AWARENESS_REGISTRATION_KEY = "pkfactory.agent-awareness.registration";
const RECENT_THREAD_SHORTCUTS_KEY = "pkfactory.recent-thread-shortcuts";
...
>()("@pkfactory/mobile/persistence/MobileStorage") {}
