...
import type { SidebarProjectGroupingMode } from "@pkfactory/contracts";
...
const PREFERENCES_KEY = "pkfactory.preferences";
const PREFERENCES_FALLBACK_KEY = "pkfactory.preferences.fallback";
...
>()("@pkfactory/mobile/persistence/MobilePreferencesStore") {}
