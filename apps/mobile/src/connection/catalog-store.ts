...
import { ConnectionTransientError } from "@pkfactory/client-runtime/connection";
...
export const CONNECTION_CATALOG_KEY = "pkfactory.connection-catalog.v1";
export const LEGACY_CONNECTIONS_KEY = "pkfactory.connections";
