...
import type { ServerProviderSkill, ServerProviderSlashCommand } from "@pkfactory/contracts";
import type { ComposerTriggerKind } from "@pkfactory/shared/composerTrigger";
...
const CommandRow = memo(function CommandRow(props: {
  ...
  return (
    ...
    >
      ...
      <Text className="shrink-0 text-base font-pkfactory-medium text-foreground" numberOfLines={1}>
    ...
    <PopoverSurface>
      {label ? (
        <View className="px-3.5 pt-2.5 pb-1">
          <Text className="text-3xs font-pkfactory-bold tracking-[0.8px] uppercase text-foreground-muted">
            {label}
          </Text>
        </View>
      ) : null}
