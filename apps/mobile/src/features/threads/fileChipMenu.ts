import { resolveMarkdownLinkPresentation } from "@pkfactory/mobile-markdown-text/links";
import type { MarkdownFileContextMenu } from "@pkfactory/mobile-markdown-text/types";
