...
} from "@pkfactory/client-runtime/state/thread-search";
import { LegendList } from "@legendapp/list/react-native";
import type { MenuAction } from "@react-native-menu/menu";
import { useAtomValue } from "@effect/atom-react";
import { type EnvironmentId, resolveEnvironmentMachineKind } from "@pkfactory/contracts";
import { sortPinnedThreadsByOrderKey } from "@pkfactory/client-runtime/state/thread-sort";
      ...
      switch (item.type) {
        ...
        case "v2-show-more":
          return (
            ...
            >
              <Text className="text-xs font-pkfactory-medium text-foreground-muted">
