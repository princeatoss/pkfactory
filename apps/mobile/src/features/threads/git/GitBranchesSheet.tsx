import { sanitizeFeatureBranchName } from "@pkfactory/shared/git";
    ...
    <View collapsable={false} className="flex-1 bg-sheet">
      ...
      >
        <View className="gap-2 rounded-[18px] border border-border bg-card px-4 py-4">
          <Text className="text-foreground-secondary text-2xs font-pkfactory-bold tracking-[1px] uppercase">
            New branch
          </Text>
          <TextInput
            value={newBranchName}
          ...
          {availableBranches.map((branch) => {
            ...
            return (
              ...
              >
                ...
                <Text className="text-foreground text-base font-pkfactory-bold">{branch.name}</Text>
