import { resolveDefaultBranchActionDialogCopy } from "@pkfactory/client-runtime/state/vcs";
import { resolveAutoFeatureBranchName } from "@pkfactory/shared/git";
  ...
  return (
    <View collapsable={false} className="flex-1 bg-sheet">
      ...
      <View className="items-center gap-1 px-5 pb-3 pt-4">
        <Text className="text-xs font-pkfactory-bold tracking-[1px] uppercase text-foreground-muted">
          Confirm
        </Text>
        <Text className="text-center text-3xl font-pkfactory-bold">
