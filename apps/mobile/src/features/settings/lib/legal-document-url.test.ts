...
describe("isLegalDocumentUrl", () => {
  it.each([
    "https://pkfactory.codes/legal",
    "https://pkfactory.codes/legal/",
    "https://pkfactory.codes/privacy-policy?source=app",
    "https://pkfactory.codes/terms-of-service#updates",
    "https://pkfactory.codes/security-policy",
  ])("allows a configured legal document: %s", (url) => {
    expect(isLegalDocumentUrl(url)).toBe(true);
  });

  it.each([
    "https://pkfactory.codes/download",
