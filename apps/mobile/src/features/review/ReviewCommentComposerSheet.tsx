      ...
      <KeyboardAvoidingView automaticOffset behavior="padding" className="flex-1">
        ...
        >
          <View className="flex-row items-center justify-between py-2">
            ...
            <Text className="text-lg font-pkfactory-bold text-foreground">Add Comment</Text>
          ...
          {!target ? (
            <View className="rounded-[22px] border border-border bg-card px-4 py-5">
              <Text className="text-base font-pkfactory-bold text-foreground">No selection</Text>
            ...
            <View className="min-h-0 flex-1 gap-4">
              <View className="gap-1 px-1">
                <Text className="text-2xs font-pkfactory-bold uppercase text-foreground-muted">
                  {selectionLabel}
                </Text>
                <Text
              ...
              <View className="min-h-0 flex-1 gap-2">
                <Text className="text-sm font-pkfactory-bold text-foreground">Comment</Text>
