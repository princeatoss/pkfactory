import { type KnownTerminalSession } from "@pkfactory/client-runtime/state/terminal";
import { DEFAULT_TERMINAL_ID, type ProjectScript } from "@pkfactory/contracts";
import { nextTerminalId, resolveTerminalSessionLabel } from "@pkfactory/shared/terminalLabels";
