...
const SHOWCASE_LOCAL_ENVIRONMENT_DISPLAY_URLS: Readonly<Record<string, string>> = {
  ...
  "Suspense Station": "https://suspense-vps.hel1.pkfactory.sh/",
...
const pocketPiEndpoint = {
  httpBaseUrl: "https://pocket-pi.pkfactory.sh",
  wsBaseUrl: "wss://pocket-pi.pkfactory.sh",
  providerKind: "pkfactory_relay" as const,
};
...
export const SHOWCASE_CONNECTED_CLOUD_ENVIRONMENTS: ReadonlyArray<ConnectedEnvironmentSummary> = [
  {
    ...
    displayUrl: "https://aurora-gpu.pkfactory.sh",
    isRelayManaged: true,
