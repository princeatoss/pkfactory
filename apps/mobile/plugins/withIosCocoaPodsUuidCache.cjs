...
const MARKER = "# pkfactory: repair cached CocoaPods UUID allocation before SPM integration";
const UUID_REPAIR = `${MARKER}
    ...
    Pod::UI.puts "PKFactory: reset CocoaPods UUID allocator at #{next_index} (#{existing_uuids.length} existing objects)"
`;
