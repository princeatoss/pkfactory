...
it("launch prompt stays a single argv-safe line naming the prompt file", () => {
  ...
  const launch = buildTriageLaunchPrompt(
    String.raw`C:\Users\a b\.pkfactory\userdata\triage\x\prompt.md`,
  );
  assert.notInclude(launch, "\n");
  assert.include(launch, String.raw`C:\Users\a b\.pkfactory\userdata\triage\x\prompt.md`);
...
it("context file carries every path the playbook depends on", () => {
  const context = buildTriageContext({
    ...
    os: "linux x64 (7.0.0)",
    nodeVersion: "v24.0.0",
    launchedAs: "npx pkfactory triage",
    server: "running (pid 42, http://127.0.0.1:4501)",
    paths: {
      stateDir: "/home/u/.pkfactory/userdata",
      dbPath: "/home/u/.pkfactory/userdata/state.sqlite",
      settingsPath: "/home/u/.pkfactory/userdata/settings.json",
      logsDir: "/home/u/.pkfactory/userdata/logs",
      serverLogPath: "/home/u/.pkfactory/userdata/logs/server.log",
      serverTracePath: "/home/u/.pkfactory/userdata/logs/server.trace.ndjson",
      providerEventLogPath: "/home/u/.pkfactory/userdata/logs/provider/events.log",
      terminalLogsDir: "/home/u/.pkfactory/userdata/logs/terminals",
      providerStatusCacheDir: "/home/u/.pkfactory/caches",
      secretsDir: "/home/u/.pkfactory/userdata/secrets",
      sourceCacheDir: "/home/u/.pkfactory/source",
    },
  });
  assert.include(context, "/home/u/.pkfactory/userdata/state.sqlite");
  assert.include(context, "/home/u/.pkfactory/userdata/logs/server.trace.ndjson");
  assert.include(context, "/home/u/.pkfactory/userdata/logs/provider/events.log");
  assert.include(context, "/home/u/.pkfactory/userdata/secrets");
  assert.include(context, "/home/u/.pkfactory/source");
  assert.include(context, "npx pkfactory triage");
