import type { ServerSelfUpdateOutcome } from "@pkfactory/contracts";
  ...
  override get message(): string {
    switch (this.operation) {
      ...
      case "version-mismatch":
        return "The service launcher started a different pkfactory version.";
...
export const ServiceLauncherHostProcess = Context.Reference<ServiceLauncherProcess>(
  "pkfactory/cloud/serviceLauncherHostProcess",
  {
    defaultValue: () => ({
...
>()("pkfactory/cloud/serviceLauncherClient") {}
