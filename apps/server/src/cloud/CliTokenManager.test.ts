import { readConnectAuthorizeRequest } from "@pkfactory/shared/connectAuth";
...
const TEST_ENV = {
  PKFACTORY_CLERK_PUBLISHABLE_KEY: "pk_test_Y2xlcmsuZXhhbXBsZS50ZXN0JA==",
  PKFACTORY_CLERK_CLI_OAUTH_CLIENT_ID: "oauth_client_test",
  PKFACTORY_HOSTED_APP_URL: "https://hosted.example.test",
};
