...
declare const __PKFACTORY_BUILD_CHANNEL__: "nightly" | "latest" | undefined;

export function resolveLoopbackAuthorizationStage(): LoopbackAuthorizationStage {
  return typeof __PKFACTORY_BUILD_CHANNEL__ === "undefined" ? "dev" : __PKFACTORY_BUILD_CHANNEL__;
}

const stageBrands = {
  dev: "PK Factory (Dev)",
  nightly: "PK Factory (Nightly)",
  latest: "PK Factory",
...
<html lang="en">
  <head>
    ...
    <title>PK Factory Connect authorization complete</title>
    <style>
      :root {
  ...
  <body>
    <main>
      ...
      <section class="content">
        ...
        <p class="description">Return to your terminal to finish setting up PK Factory Connect. You can close this window.</p>
      </section>
    </main>
  </body>
</html>`;
