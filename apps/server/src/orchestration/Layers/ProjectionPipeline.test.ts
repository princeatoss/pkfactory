...
const BaseTestLayer = makeProjectionPipelinePrefixedTestLayer(
  "pkfactory-projection-pipeline-test-",
);

it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("pkfactory-projection-cursor-batch-")),
...
it.layer(Layer.fresh(makeProjectionPipelinePrefixedTestLayer("pkfactory-base-")))(
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("pkfactory-projection-attachments-safe-")),
...
it.layer(
  Layer.fresh(
    makeProjectionPipelinePrefixedTestLayer("pkfactory-projection-attachments-overwrite-"),
  ),
)("OrchestrationProjectionPipeline", (it) => {
...
it.layer(
  Layer.fresh(
    makeProjectionPipelinePrefixedTestLayer("pkfactory-projection-attachments-rollback-"),
  ),
)("OrchestrationProjectionPipeline", (it) => {
    ...
    Effect.gen(function* () {
      ...
      yield* appendAndProject({
        ...
        payload: {
          ...
          checkpointRef: CheckpointRef.make(
            "refs/pkfactory/checkpoints/thread-revert-files/turn/1",
          ),
          status: "ready",
          files: [],
      ...
      yield* appendAndProject({
        ...
        payload: {
          ...
          checkpointRef: CheckpointRef.make(
            "refs/pkfactory/checkpoints/thread-revert-files/turn/2",
          ),
          status: "ready",
          files: [],
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("pkfactory-projection-attachments-revert-")),
)("OrchestrationProjectionPipeline", (it) => {
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("pkfactory-projection-attachments-delete-")),
)("OrchestrationProjectionPipeline", (it) => {
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("pkfactory-projection-attachments-replay-")),
)("OrchestrationProjectionPipeline", (it) => {
      ...
      Effect.gen(function* () {
        ...
        yield* appendAndProject({
          ...
          payload: {
            ...
            turnId: TurnId.make("turn-completed"),
            checkpointTurnCount: 1,
            checkpointRef: CheckpointRef.make("refs/pkfactory/checkpoints/thread-conflict/turn/1"),
            status: "ready",
            files: [],
      ...
      const refreshEvents = [
        ...
        },
        {
          ...
          payload: {
            ...
            turnId: TurnId.make("turn-shell-summary-1"),
            checkpointTurnCount: 1,
            checkpointRef: CheckpointRef.make("refs/pkfactory/checkpoints/thread-shell-summary/1"),
            status: "ready",
            files: [],
    ...
    Effect.gen(function* () {
      ...
      yield* appendAndProject({
        ...
        payload: {
          ...
          checkpointTurnCount: 1,
          checkpointRef: CheckpointRef.make("refs/pkfactory/checkpoints/thread-revert/turn/1"),
          status: "ready",
          files: [],
      ...
      yield* appendAndProject({
        ...
        payload: {
          ...
          checkpointTurnCount: 2,
          checkpointRef: CheckpointRef.make("refs/pkfactory/checkpoints/thread-revert/turn/2"),
          status: "ready",
          files: [],
...
it.layer(makeProjectionPipelinePrefixedTestLayer("pkfactory-pending-turn-terminal-test-"))(
    ...
    Effect.provide(
      Layer.provideMerge(
        ServerConfig.layerTest(process.cwd(), {
          prefix: "pkfactory-projection-pipeline-restart-",
        }),
        NodeServices.layer,
      ),
    ),
...
const engineLayer = it.layer(
  OrchestrationEngineLive.pipe(
    ...
    Layer.provideMerge(
      ServerConfig.layerTest(process.cwd(), {
        prefix: "pkfactory-projection-pipeline-engine-dispatch-",
      }),
    ),
    Layer.provideMerge(NodeServices.layer),
  ),
