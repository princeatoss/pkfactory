    ...
    const events: ReadonlyArray<OrchestrationEvent> = [
      ...
      makeEvent({
        ...
        payload: {
          ...
          checkpointRef: "refs/pkfactory/checkpoints/thread-1/turn/1",
          status: "ready",
          files: [],
      ...
      makeEvent({
        ...
        payload: {
          ...
          checkpointRef: "refs/pkfactory/checkpoints/thread-1/turn/2",
          status: "ready",
          files: [],
    ...
    const events: ReadonlyArray<OrchestrationEvent> = [
      makeEvent({
        ...
        payload: {
          ...
          turnId: "turn-1",
          checkpointTurnCount: 1,
          checkpointRef: "refs/pkfactory/checkpoints/thread-revert/turn/1",
          status: "ready",
          files: [],
      ...
      makeEvent({
        ...
        payload: {
          ...
          turnId: "turn-2",
          checkpointTurnCount: 2,
          checkpointRef: "refs/pkfactory/checkpoints/thread-revert/turn/2",
          status: "ready",
          files: [],
      ...
      (_, index) =>
        makeEvent({
          ...
          payload: {
            ...
            checkpointRef: `refs/pkfactory/checkpoints/thread-capped/turn/${index + 1}`,
            status: "ready",
            files: [],
