...
// per-command cache lookups in @pkfactory/shared/shell.
//
...
// command-resolution cache in @pkfactory/shared/shell, so a backward wall-clock
...
>()("pkfactory/process/externalLauncher") {}
