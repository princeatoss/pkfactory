 ...
 */
import { type RemoteOpenTarget } from "@pkfactory/contracts";
import { HostProcessHostname } from "@pkfactory/shared/hostProcess";
import * as NetService from "@pkfactory/shared/Net";
import { readTailscaleStatus } from "@pkfactory/tailscale";
...
>()("pkfactory/environment/RemoteOpenTargets") {}
