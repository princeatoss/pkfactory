...
import type { VcsDriverKind, VcsError, VcsRepositoryIdentity } from "@pkfactory/contracts";
import { VcsUnsupportedOperationError } from "@pkfactory/contracts";
...
>()("pkfactory/vcs/VcsDriverRegistry") {}
