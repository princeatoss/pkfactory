  ...
  const checkpoints: VcsDriver.VcsCheckpointOps = {
    captureCheckpoint: Effect.fn("GitVcsDriver.checkpoints.captureCheckpoint")(function* (input) {
      ...
      const tempIndexPath = path.join(
        gitCommonDir,
        `pkfactory-checkpoint-index-${NodeCrypto.randomUUID()}`,
      );
      const commitEnv: NodeJS.ProcessEnv = {
        ...process.env,
        GIT_INDEX_FILE: tempIndexPath,
        GIT_AUTHOR_NAME: "PK Factory",
        GIT_AUTHOR_EMAIL: "pkfactory@users.noreply.github.com",
        GIT_COMMITTER_NAME: "PK Factory",
        GIT_COMMITTER_EMAIL: "pkfactory@users.noreply.github.com",
      };
      ...
      yield* Effect.gen(function* () {
        ...
        const message = `pkfactory checkpoint ref=${input.checkpointRef}`;
