  ...
  it.effect("carries every repository and every qualifier into one search", () =>
    Effect.gen(function* () {
      ...
      yield* cli.searchPullRequests({
        cwd: "/w",
        host: "github.com",
        repositories: ["acme/web", "princeatoss/pkfactory"],
        state: "closed",
        involvement: "reviewing",
        viewer: "bilal",
        limit: 10,
      ...
      assert.strictEqual(
        ...
        'is:pr is:closed is:unmerged review-requested:bilal "pull requests page" ' +
          "updated:<=2026-07-02T00:00:00Z sort:updated-desc repo:acme/web repo:princeatoss/pkfactory",
      );
    }),
  );
    ...
    Effect.gen(function* () {
      mockedExecute.mockReturnValue(
        Effect.succeed(
          searchPage([
            ...
            searchItem(9, "princeatoss/pkfactory", "2026-07-02T00:00:00Z"),
      ...
      assert.deepStrictEqual(
        ...
        [
          ...
          ["princeatoss/pkfactory", 9, "https://avatars/octocat"],
        ],
      );
