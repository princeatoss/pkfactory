...
import { isDevProxiedPath } from "@pkfactory/shared/devProxy";
import { decodeOtlpTraceRecords } from "@pkfactory/shared/observability";
...
const DESKTOP_RENDERER_ORIGINS = ["pkfactory://app", "pkfactory-dev://app"];
...
export const browserApiCorsLayer = Layer.unwrap(
  Effect.gen(function* () {
    ...
    //
    // PKFACTORY_DEV_ALLOWED_ORIGINS covers dev servers reached from a second
