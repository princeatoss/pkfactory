...
import { SourceControlProviderError, type ChangeRequest } from "@pkfactory/contracts";
...
export const makeDiscovery = Effect.gen(function* () {
  ...
  return {
    ...
    label: "Bitbucket",
    installHint:
      "Set PKFACTORY_BITBUCKET_EMAIL and PKFACTORY_BITBUCKET_API_TOKEN on the server (use a Bitbucket API token with pull request, repository, and user read scopes).",
