...
import { VcsProcessExitError, VcsProcessSpawnError } from "@pkfactory/contracts";
...
describe("GitHubCli.layer", () => {
  ...
  it.effect("keeps pull requests from gh versions without headRepository.nameWithOwner", () =>
    ...
    Effect.gen(function* () {
            ...
            JSON.stringify([
              {
                ...
                baseRefName: "main",
                headRefName: "pkfactory/codex-turn-mapping",
                state: "OPEN",
                mergedAt: null,
      ...
      const result = yield* gh.listOpenPullRequests({
        cwd: "/repo",
        headSelector: "pkfactory/codex-turn-mapping",
      });
