    ...
    const provider = yield* makeProvider({
      getPullRequest: () =>
        Effect.succeed({
          ...
          headRepositoryNameWithOwner: "fork/pkfactory",
...
it.effect("adds safe request context while retaining GitHub CLI causes", () =>
  Effect.gen(function* () {
    ...
    const error = yield* provider
      .getChangeRequest({
        cwd: "/repo",
        reference: "https://user:secret@github.com/princeatoss/pkfactory/pull/42?token=secret#diff",
      })
      .pipe(Effect.flip);
    ...
    assert.deepStrictEqual(
      ...
      },
      {
        ...
        command: "gh",
        cwd: "/repo",
        reference: "https://github.com/princeatoss/pkfactory/pull/42",
            ...
            JSON.stringify([
              {
                number: 7,
                title: "Merged work",
                url: "https://github.com/princeatoss/pkfactory/pull/7",
                baseRefName: "main",
