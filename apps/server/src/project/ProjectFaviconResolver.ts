...
>()("pkfactory/project/ProjectFaviconResolver") {}
...
export const make = Effect.gen(function* () {
  ...
  const projectFileLoader = yield* PKFactoryProjectFileLoader.PKFactoryProjectFileLoader;
  ...
  const resolvePathUncached = Effect.fn("ProjectFaviconResolver.resolvePathUncached")(function* (
    ...
    // A pkfactory.json iconPath takes precedence over the well-known locations.
