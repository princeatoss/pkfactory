import { ProjectId } from "@pkfactory/contracts";
import { projectScriptRuntimeEnv, setupProjectScript } from "@pkfactory/shared/projectScripts";
...
>()("pkfactory/project/ProjectSetupScriptRunner") {}
