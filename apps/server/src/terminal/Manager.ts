...
import { makeKeyedCoalescingWorker } from "@pkfactory/shared/KeyedCoalescingWorker";
import { HostProcessPlatform } from "@pkfactory/shared/hostProcess";
import { getTerminalLabel } from "@pkfactory/shared/terminalLabels";
...
>()("pkfactory/terminal/Manager/TerminalManager") {}
...
function shouldExcludeTerminalEnvKey(key: string): boolean {
  ...
  if (normalizedKey.startsWith("PKFACTORY_")) {
    return true;
  }
