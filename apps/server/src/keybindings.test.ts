import { KeybindingCommand, KeybindingRule, KeybindingsConfig } from "@pkfactory/contracts";
...
import { KeybindingsConfigError } from "@pkfactory/contracts";
    ...
    Layer.provideMerge(
      Layer.fresh(
        ServerConfig.layerTest(process.cwd(), {
          prefix: "pkfactory-keybindings-test-",
        }),
      ),
    ),
  );
