 ...
 * Enable with: PKFACTORY_CURSOR_ACP_PROBE=1 bun run test --filter CursorAcpCliProbe
 */
...
describe.runIf(process.env.PKFACTORY_CURSOR_ACP_PROBE === "1")("Cursor ACP CLI probe", () => {
    ...
    Effect.gen(function* () {
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          ...
          clientInfo: { name: "pkfactory-probe", version: "0.0.0" },
