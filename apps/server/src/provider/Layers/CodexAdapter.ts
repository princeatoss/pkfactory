          ...
          ...(mcpSession
            ? {
                environment: {
                  ...
                  PKFACTORY_MCP_BEARER_TOKEN: mcpSession.authorizationHeader.replace(
                    /^Bearer\s+/,
                    "",
                  ),
                },
                appServerArgs: [
                  "-c",
                  `mcp_servers.pkfactory.url=${mcpSession.endpoint}`,
                  "-c",
                  'mcp_servers.pkfactory.bearer_token_env_var="PKFACTORY_MCP_BEARER_TOKEN"',
                ],
              }
            : {}),
        };
