import { tokenizeCliArgs } from "@pkfactory/shared/cliArgs";

export const PKFACTORY_CODEX_LAUNCH_ARGS_ENV = "PKFACTORY_CODEX_LAUNCH_ARGS";

export const resolveCodexLaunchArgs = (
  launchArgs?: string,
  environment: NodeJS.ProcessEnv = process.env,
) => environment[PKFACTORY_CODEX_LAUNCH_ARGS_ENV]?.trim() || launchArgs?.trim() || "";
