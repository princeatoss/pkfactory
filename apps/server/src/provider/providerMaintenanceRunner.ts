...
>()("pkfactory/provider/providerMaintenanceRunner") {}
            ...
            return yield* finish(
              makeUpdateState({
                ...
                message: couldNotVerify
                  ? "Update command completed, but PK Factory could not verify the provider version."
                  : stillOutdated
                    ? "Update command completed, but PK Factory still detects an outdated provider version."
                    : "Provider updated.",
                output: commandOutput(result),
              }),
            );
