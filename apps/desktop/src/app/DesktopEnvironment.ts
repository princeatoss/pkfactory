...
export class DesktopEnvironment extends Context.Service<
  DesktopEnvironment,
  {
    ...
    readonly devRemotePKFactoryServerEntryPath: Option.Option<string>;
...
>()("@pkfactory/desktop/app/DesktopEnvironment") {}

const APP_BASE_NAME = "PK Factory";
...
const make = Effect.fn("desktop.environment.make")(function* (
  ...
  const baseDir = resolveDesktopBaseDir({
    homeDirectory,
    joinPath: path.join,
    pkfactoryHome: config.pkfactoryHome,
  });
  ...
  const userDataDirName = isDevelopment ? "pkfactory-dev" : "pkfactory";
  const legacyUserDataDirName = isDevelopment ? "PK Factory (Dev)" : "PK Factory (Alpha)";
  ...
  return DesktopEnvironment.of({
    ...
    devServerUrl,
    devRemotePKFactoryServerEntryPath: config.devRemotePKFactoryServerEntryPath,
    ...
    appUserModelId: Option.getOrElse(config.appUserModelIdOverride, () =>
      isDevelopment ? "com.pkfactory.pkfactory.dev" : "com.pkfactory.pkfactory",
    ),
    linuxDesktopEntryName: isDevelopment ? "pkfactory-dev.desktop" : "pkfactory.desktop",
    linuxWmClass: isDevelopment ? "pkfactory-dev" : "pkfactory",
