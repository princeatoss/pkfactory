import { PRIMARY_LOCAL_ENVIRONMENT_ID } from "@pkfactory/contracts";
import { makeLocalFileTracer, makeTraceSink } from "@pkfactory/shared/observability";
...
>()("@pkfactory/desktop/app/DesktopObservability/DesktopBackendOutputLogFactory") {}
