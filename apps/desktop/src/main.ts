...
import { resolveRemotePKFactoryCliPackageSpec } from "@pkfactory/ssh/command";
import type { RemotePKFactoryRunnerOptions } from "@pkfactory/ssh/tunnel";
...
const resolveDesktopSshCliRunner = (
...
): RemotePKFactoryRunnerOptions => {
  const devRemoteEntryPath = Option.getOrUndefined(environment.devRemotePKFactoryServerEntryPath);
  ...
  return {
    packageSpec: resolveRemotePKFactoryCliPackageSpec({
