...
const OVERLAY_ATTRIBUTE = "data-pkfactory-annotation-ui";
const Z_INDEX_OVERLAY = 2147483646;
const PRIMARY = "var(--pkfactory-primary)";
const PRIMARY_FILL = "color-mix(in srgb, var(--pkfactory-primary) 10%, transparent)";
...
const applyAnnotationTheme = (
  ...
  const variables = {
    "--pkfactory-radius": theme.radius,
    "--pkfactory-background": theme.background,
    "--pkfactory-foreground": theme.foreground,
    "--pkfactory-popover": theme.popover,
    "--pkfactory-popover-foreground": theme.popoverForeground,
    "--pkfactory-primary": theme.primary,
    "--pkfactory-primary-foreground": theme.primaryForeground,
    "--pkfactory-muted": theme.muted,
    "--pkfactory-muted-foreground": theme.mutedForeground,
    "--pkfactory-accent": theme.accent,
    "--pkfactory-accent-foreground": theme.accentForeground,
    "--pkfactory-border": theme.border,
    "--pkfactory-input": theme.input,
    "--pkfactory-ring": theme.ring,
    "--pkfactory-font-sans": theme.fontSans,
    "--pkfactory-font-mono": theme.fontMono,
  };
...
function startAnnotation(): void {
  ...
  const refreshToolButtons = (): void => {
    ...
    document.documentElement.setAttribute("data-pkfactory-annotation-tool", tool);
  };
      ...
      if (isUsableRect(rect)) {
        ...
        if (found === 0) {
          ...
          const regionBox = createBox(
            PRIMARY,
            "color-mix(in srgb, var(--pkfactory-primary) 6%, transparent)",
          );
  ...
  const teardown = (notifyMain: boolean): void => {
    ...
    document.documentElement.removeAttribute("data-pkfactory-annotation-tool");
    cursorStyle.remove();
    host.remove();
    activeSession = null;
