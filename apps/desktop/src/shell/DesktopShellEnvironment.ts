...
>()("@pkfactory/desktop/shell/DesktopShellEnvironment") {}
...
const startMarker = (name: string) => `__PKFACTORY_ENV_${name}_START__`;
const endMarker = (name: string) => `__PKFACTORY_ENV_${name}_END__`;
