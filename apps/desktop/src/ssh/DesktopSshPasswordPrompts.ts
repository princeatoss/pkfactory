import type { DesktopSshPasswordPromptRequest } from "@pkfactory/contracts";
import { DesktopSshPasswordPromptResolutionInputSchema } from "@pkfactory/contracts";
import type { SshPasswordRequest } from "@pkfactory/ssh/auth";
...
export class DesktopSshPromptWindowUnavailableError extends Schema.TaggedErrorClass<DesktopSshPromptWindowUnavailableError>()(
  ...
  override get message(): string {
    ...
    return `PK Factory window is unavailable during ${this.stage} for SSH authentication to ${this.destination} (request: ${request}).`;
  }
}
...
>()("@pkfactory/desktop/ssh/DesktopSshPasswordPrompts") {}
