...
function getGnomeKeyringRemediationMessage(): string {
  return "PK Factory could not access GNOME Keyring to save this environment credential. Install and start GNOME Keyring, then restart PK Factory.";
}

function getKWalletRemediationMessage(): string {
  return "PK Factory could not access KWallet to save this environment credential. Enable the KDE wallet subsystem in System Settings, then restart PK Factory.";
}
