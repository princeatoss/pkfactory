import type { RelayDeviceRegistrationRequest } from "@pkfactory/contracts/relay";
...
const registration: RelayDeviceRegistrationRequest = {
  ...
  bundleId: "com.pkfactory.pkfactory.preview" as RelayDeviceRegistrationRequest["bundleId"],
    ...
    return Effect.gen(function* () {
      ...
      expect(insertedValues).toEqual([
        expect.objectContaining({
          userId: "user-2",
          deviceId: "device-1",
          bundleId: "com.pkfactory.pkfactory.preview",
          apsEnvironment: "production",
