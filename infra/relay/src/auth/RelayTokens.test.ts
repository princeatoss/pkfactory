...
import { signRelayJwt } from "@pkfactory/shared/relayJwt";
  ...
  it.effect("rejects signed DPoP tokens whose scope is outside the relay policy", () =>
    Effect.gen(function* () {
      ...
      const token = yield* signRelayJwt({
        ...
        typ: "pkfactory-relay-dpop-access+jwt",
        payload: {
