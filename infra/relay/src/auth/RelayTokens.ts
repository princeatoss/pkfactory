...
import { encodeOAuthScope, parseAllowedOAuthScope } from "@pkfactory/shared/oauthScope";
import {
...
const LINK_CHALLENGE_TYP = "pkfactory-link-challenge+jwt";
const ACCESS_TOKEN_TYP = "pkfactory-relay-dpop-access+jwt";
...
>()("pkfactory-relay/auth/RelayTokens") {}
