  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new PK Factory prerelease is available for nightly testers."
          : "A new PK Factory latest release is available.",
...
).pipe(Command.withDescription("Post a PK Factory release announcement to Discord."));
