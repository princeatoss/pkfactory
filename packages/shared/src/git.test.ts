import type { VcsStatusRemoteResult, VcsStatusResult } from "@pkfactory/contracts";
...
describe("normalizeGitRemoteUrl", () => {
  it("canonicalizes equivalent GitHub remotes across protocol variants", () => {
    expect(normalizeGitRemoteUrl("git@github.com:PKFactoryTools/PKFactory.git")).toBe(
      "github.com/pkfactorytools/pkfactory",
    );
    expect(normalizeGitRemoteUrl("https://github.com/PKFactoryTools/PKFactory.git")).toBe(
      "github.com/pkfactorytools/pkfactory",
    );
    expect(normalizeGitRemoteUrl("ssh://git@github.com/PKFactoryTools/PKFactory")).toBe(
      "github.com/pkfactorytools/pkfactory",
    );
  });

  it("preserves nested group paths for providers like GitLab", () => {
    expect(normalizeGitRemoteUrl("git@gitlab.com:PKFactoryTools/platform/PKFactory.git")).toBe(
      "gitlab.com/pkfactorytools/platform/pkfactory",
    );
    expect(normalizeGitRemoteUrl("https://gitlab.com/PKFactoryTools/platform/PKFactory.git")).toBe(
      "gitlab.com/pkfactorytools/platform/pkfactory",
    );
  });
...
describe("parseGitHubRepositoryNameWithOwnerFromRemoteUrl", () => {
  it("extracts the owner and repository from common GitHub remote shapes", () => {
    ...
    ).toBe("PKFactoryTools/PKFactory");
    expect(
      parseGitHubRepositoryNameWithOwnerFromRemoteUrl(
        "https://github.com/PKFactoryTools/PKFactory.git",
      ),
    ).toBe("PKFactoryTools/PKFactory");
  });
});
