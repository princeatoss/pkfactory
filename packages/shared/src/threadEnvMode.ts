import type { ThreadEnvMode } from "@pkfactory/contracts";

/**
 * Canonical priority order for a project's default thread env mode:
 * per-project setting > checked-in pkfactory.json > global server setting.
 *
 ...
 * source that outranks pkfactory.json decided, or the file read settled. While
