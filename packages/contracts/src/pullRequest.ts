...
> = {
  ...
  bitbucket: {
    missing:
      "Bitbucket needs API credentials on the server. Set PKFACTORY_BITBUCKET_EMAIL and PKFACTORY_BITBUCKET_API_TOKEN, or PKFACTORY_BITBUCKET_ACCESS_TOKEN.",
    unauthenticated:
      "Bitbucket rejected the configured credentials. Check PKFACTORY_BITBUCKET_EMAIL and PKFACTORY_BITBUCKET_API_TOKEN.",
  },
};
