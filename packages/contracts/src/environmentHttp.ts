...
>()("@pkfactory/contracts/environmentHttp/EnvironmentAuthenticatedPrincipal") {}
...
export class EnvironmentMetadataHttpApi extends HttpApiGroup.make("metadata").add(
  HttpApiEndpoint.get("descriptor", "/.well-known/pkfactory/environment", {
...
export class EnvironmentConnectHttpApi extends HttpApiGroup.make("connect")
  ...
  .add(
    HttpApiEndpoint.post("health", "/api/pkfactory-connect/health", {
  ...
  .add(
    HttpApiEndpoint.post("pkfactoryMintCredential", "/api/pkfactory-connect/mint-credential", {
      payload: RelayCloudMintCredentialRequest,
      success: RelayEnvironmentMintResponse,
      error: EnvironmentHttpCloudErrors,
    }),
