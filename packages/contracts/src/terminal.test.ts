...
describe("TerminalOpenInput", () => {
  ...
  it("accepts optional env overrides", () => {
    const parsed = decodeSync(TerminalOpenInput, {
      ...
      terminalId: DEFAULT_TERMINAL_ID,
      cwd: "/tmp/project",
      worktreePath: "/tmp/project/.pkfactory/worktrees/feature-a",
      cols: 100,
      rows: 24,
      env: {
        PKFACTORY_PROJECT_ROOT: "/tmp/project",
        CUSTOM_FLAG: "1",
      },
    });
    ...
    expect(parsed.worktreePath).toBe("/tmp/project/.pkfactory/worktrees/feature-a");
  });
    ...
    expect(
      decodes(TerminalEvent, {
        ...
        snapshot: {
          threadId: "thread-1",
          terminalId: DEFAULT_TERMINAL_ID,
          cwd: "/tmp/project/.pkfactory/worktrees/feature-a",
          worktreePath: "/tmp/project/.pkfactory/worktrees/feature-a",
          status: "running",
          pid: 1234,
          history: "",
