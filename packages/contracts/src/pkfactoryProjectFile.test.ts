...
import { PKFactoryProjectFile } from "./pkfactoryProjectFile.ts";

const decode = Schema.decodeUnknownSync(PKFactoryProjectFile);

describe("PKFactoryProjectFile", () => {
  it("decodes a full project file", () => {
    const decoded = decode({
      $schema: "https://pkfactory.codes/schema/pkfactory.json",
