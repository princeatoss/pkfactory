import type { DesktopSshEnvironmentTarget, EnvironmentId } from "@pkfactory/contracts";
import { resolveRemotePairingTarget } from "@pkfactory/shared/remote";
...
>()("@pkfactory/client-runtime/connection/onboarding/ConnectionOnboarding") {}
