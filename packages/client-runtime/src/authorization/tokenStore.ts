...
import { RelayManagedEndpoint } from "@pkfactory/contracts/relay";
...
export class RemoteDpopAccessToken extends Schema.Class<RemoteDpopAccessToken>(
  "@pkfactory/client-runtime/authorization/RemoteDpopAccessToken",
)({
...
>()("@pkfactory/client-runtime/authorization/tokenStore/RemoteDpopAccessTokenStore") {}
