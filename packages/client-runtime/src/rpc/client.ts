import { ORCHESTRATION_WS_METHODS, WS_METHODS } from "@pkfactory/contracts";
...
}>("@pkfactory/client-runtime/rpc/EnvironmentRpcRequestObserver", {
  defaultValue: () => ({
...
}>("@pkfactory/client-runtime/rpc/EnvironmentRpcSubscriptionObserver", {
  defaultValue: () => ({
    observe: () => Effect.succeed(Effect.void),
  }),
}) {}
