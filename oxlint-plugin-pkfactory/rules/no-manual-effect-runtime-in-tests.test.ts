...
const rule = createOxlintRuleHarness("pkfactory/no-manual-effect-runtime-in-tests", {
  filename: "fixture.test.ts",
});

describe("pkfactory/no-manual-effect-runtime-in-tests", () => {
  rule.valid(
...
const productionRule = createOxlintRuleHarness("pkfactory/no-manual-effect-runtime-in-tests");
...
const legacyRule = createOxlintRuleHarness("pkfactory/no-manual-effect-runtime-in-tests", {
  filename: "legacy.test.ts",
  ruleOptions: [{ maxOccurrences: 2 }],
});

describe("pkfactory/no-manual-effect-runtime-in-tests with maxOccurrences", () => {
  legacyRule.valid(
