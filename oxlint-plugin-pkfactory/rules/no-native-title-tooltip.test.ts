...
const rule = createOxlintRuleHarness("pkfactory/no-native-title-tooltip", {
  filename: "fixture.tsx",
});

describe("pkfactory/no-native-title-tooltip", () => {
  rule.valid(
  ...
  rule.valid("allows document.title assignments", `document.title = "Thread · PK Factory";`);
